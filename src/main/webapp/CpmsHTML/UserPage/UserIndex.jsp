...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            <h1>欢迎您！${userLogin.account}</h1>
            <p>小区物业管理系统将带给您最真挚和最温暖的服务！欢迎回家！</p>
            <div class="margin-bottom-30">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="#">家 <span class="badge">42</span></a></li>
                            <li class="active"><a href="#">呵护 <span class="badge">126</span></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    ...
                                    <strong>文明创建重在行动，树立新风贵在坚持!</strong>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 margin-bottom-30">
                        <div class="panel panel-success">
                            <div class="panel-heading">小区动态</div>
                            近段时期为非常时期，各小区业主应该要提高防疫意识，减少出门次数，做好防疫措施!
                            <canvas id="templatemo-line-chart" height="120" width="500">
                            </canvas>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 margin-bottom-30">
